...
import { getPackagesByDestination } from "@/lib/packages-data";

// Datos de destinos - será reemplazado por Supabase
          ...
          <div className="container mx-auto px-4 lg:px-12 xl:px-20">
            ...
            >
              ...
              <p className="text-white/90 mb-8 max-w-xl mx-auto">
                Escribinos y te armamos el viaje perfecto a tu medida.
